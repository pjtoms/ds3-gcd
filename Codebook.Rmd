---
title: "Codebook.Rmd"
author: "[Patrick (Pat) T...](https://github.com/pjtoms)"
output:
  md_document:
...
See [run_analysis.html](https://github.com/pjtoms/ "run_analysis.Rmd output") for a detailed description of data transformations, clean up, and the code used in production of the tidy data file.
