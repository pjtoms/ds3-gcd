...
See [run_analysis.html](https://github.com/pjtoms/ds3-gcd/run_analysis.html "run_analysis.Rmd output") for a detailed description of data transformations, clean up, and the code used in production of the tidy data file.
